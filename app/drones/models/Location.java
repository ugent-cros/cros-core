...
public class Location implements Serializable {
    ...
    public static double distance(Location l1, double longitude2, double latitude2){
        float[] res = computeDistanceAndBearing(l1.getLatitude(), latitude2, l1.getLongtitude(), longitude2);
        return res[0];
    }
    ...
    public static float[] computeDistanceAndBearing(Location l1, Location l2) {
        return computeDistanceAndBearing(l1.getLatitude(), l2.getLatitude(), l1.getLongtitude(), l2.getLongtitude());
    }
