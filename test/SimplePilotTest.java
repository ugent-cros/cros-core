        ...
        new JavaTestKit(system) {
            {
                ...
                simplePilot.tell(new RequestGrantedMessage(new RequestMessage(LocationMessage.RequestType.TAKEOFF,simplePilot,STERRE)),getRef());
                ...
                simplePilot.tell(new RequestGrantedMessage(new RequestMessage(LocationMessage.RequestType.LANDING,simplePilot,tmp)),getRef());
